...
export function KursyPageContent() {
  return (
          ...
          >
            <div className="w-full sm:w-1/3">
              <div className="flex flex-col gap-1">
                <span className="text-xs font-semibold uppercase tracking-wider text-red-600">{course.category}</span>
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-sm sm:flex sm:gap-8">
              <div className="flex flex-col">
                ...
                <span className="font-medium text-stone-900">{course.startDate}</span>
              </div>
              <div className="flex flex-col">
                <span className="text-stone-500">Czas trwania</span>
                <span className="font-medium text-stone-900">{course.duration}</span>
              </div>
              <div className="flex flex-col">
                <span className="text-stone-500">Cena</span>
                <span className="font-medium text-stone-900">{course.price}</span>
              </div>
              <div className="flex flex-col">
                <span className="text-stone-500">Zapisanych</span>
                <span className="font-medium text-stone-900">{course.spots}</span>
              </div>
            </div>
