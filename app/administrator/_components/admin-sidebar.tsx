    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M10.34 15.84c-.688-.06-1.386-.09-2.09-.09H7.5a4.5 4.5 0 110-9h.75c.704 0 1.402-.03 2.09-.09m0 9.18c.253.962.584 1.892.985 2.783.247.55.06 1.21-.463 1.511l-.657.38a.953.953 0 01-1.317-.456 20.21 20.21 0 01-1.062-2.573m.671-5.076a13.857 13.857 0 012.1-5.547m0 0a13.86 13.86 0 00-2.1-5.547m2.1 5.547c1.37.07 2.717.217 4.035.44a.86.86 0 01.71.85v3.456c0 .434-.31.797-.71.85a19.566 19.566 0 01-4.035.44"
        />
      </svg>
    ),
  },
  ...
  return (
    <aside className="sticky top-6 hidden h-[calc(100vh-3rem)] w-64 shrink-0 overflow-hidden rounded-3xl bg-linear-to-br from-stone-900 via-stone-900 to-stone-950 shadow-2xl lg:flex lg:flex-col lg:justify-between">
      <div className="space-y-6 p-8 pb-0">
        ...
        <div>
          <h2 className="text-lg font-bold text-white">Panel OSK</h2>
          <p className="mt-0.5 text-xs text-stone-500">
            Zarządzaj ośrodkiem szkolenia
          </p>
        </div>
