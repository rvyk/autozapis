...
export function DashboardPageContent({ firstName }: { firstName?: string | null }) {
  return (
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {DASHBOARD_STATS.map((stat) => (
          ...
          >
            ...
            <p className={stat.alert ? "text-xs font-medium text-red-600" : "text-xs font-medium text-stone-400"}>
              {stat.trend}
            </p>
          </div>
        ))}
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="col-span-1 flex flex-col gap-4">
          <div className="rounded-2xl border border-red-100 bg-red-50/50 p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-red-900">Uwaga, 3 nowe wnioski</h2>
