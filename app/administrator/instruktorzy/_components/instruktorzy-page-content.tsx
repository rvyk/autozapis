...
const MOCK_INSTRUCTORS = [
  { id: 1, name: "Janusz Kaczmarek", phone: "+48 123 456 789", activeTrainees: 12, rating: 4.9 },
  { id: 2, name: "Anna Lewandowska", phone: "+48 987 654 321", activeTrainees: 8, rating: 4.8 },
  { id: 3, name: "Piotr Wróbel", phone: "+48 555 111 222", activeTrainees: 15, rating: 5.0 },
];
  ...
  return (
    <div className="flex w-full flex-col gap-8 animate-in fade-in duration-300 ease-out">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-stone-900">Instruktorzy</h1>
          <p className="mt-2 text-stone-500">Zarządzaj zespołem instruktorów prowadzących jazdy i wykłady.</p>
        </div>
        <div>
        ...
        {MOCK_INSTRUCTORS.map((instruktor) => (
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <Button variant="ghost" size="sm" className="text-stone-400 hover:text-red-500">
            ...
            <div>
              <h3 className="text-lg font-semibold text-stone-900">{instruktor.name}</h3>
              <p className="text-sm text-stone-500">{instruktor.phone}</p>
            </div>

            <div className="mt-2 flex items-center gap-4">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-stone-900">{instruktor.activeTrainees}</span>
